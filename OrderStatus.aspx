<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="Project.Admin.OrderStatus" %>
                                    ...
                                    <asp:Panel ID="pUpdateOrderstatus" runat="server">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvDdlOrderstatus" runat="server" ControlToValidate="ddlorderStatus" Display="Dynamic" 
                                                        ErrorMessage="Order status is req." ForeColor="Red" InitialValue="0" SetFocusOnError="True"></asp:RequiredFieldValidator>
