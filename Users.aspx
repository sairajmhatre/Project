<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="Project.Admin.Users" %>
                                                         ...
                                                         <td> <%# Eval("CreateDate") %></td>
                                                          <td>                                                         
                                                              <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                  ...
                                                                  OnClientClick="return Confirm('Do you want to delete this Usre?');">
                                                                      <i class="ti-trash"></i>
                                                              </asp:LinkButton>
                                                        </td>
                                                     </tr>
