<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Project.User.Contact" %>
                    ...
                    <form>
                        <div class="row g-3">
                           ...
                           <%-- <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="btn btn-secondary rounded-pill py-3 px-5" OnClick="btnSubmit_Click" />
